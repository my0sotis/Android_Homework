...
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.OverClip;
import com.mikeriv.ssui_2016.a2_collage_basecode.drawing.PileLaout;
...
public abstract class CollageViewTestHelper {
     ...
     * 根据传入的相关菜单项运行测试如果在此文件中添加测试用例，则需要将其绑定到关联的选项
    ...
    private static final void updateCollageViewWithRoot(CollageView collageView, BaseVisualElement root) {
        if (collageView == null) {
            Log.e(TAG, "CollageView can't be null for testing");
        }
    ...
    //下面是一系列注释掉的测试编码 - 一旦您实现了这些要求，您可以使用它们来测试视图层次结构和预期输出
    private static void putSamplesInElement(
            BaseVisualElement rootVisualElement,
        ...
        //实现后取消注释：SimpleFrame，SolidBackDrop，IconImage，NinePartImage，TextVisualElement
...
//         **/
        ...
        PileLaout p = new PileLaout(10, 400, 200, 200);
...
//        **/
        ...
        OverClip o = new OverClip(5, 300, 1000, 1080);
